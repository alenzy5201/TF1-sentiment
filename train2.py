...
def train(x, y, vocab_processor ,lr, dropout, l2_lambda):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.getcwd(), "runs_02", 'lr={}\drop={}\l2_lambda={}'.format(lr,dropout,l2_lambda)))
            print("Writing to {}\n".format(out_dir))
    ...
    for lr in [1e-4]:
        for dropout in [x/10 for x in range(10, 6, -1)]:
            for l2_lambda in range(100,0,-20):
                train(x, y, vocab_processor, lr, dropout, l2_lambda)
